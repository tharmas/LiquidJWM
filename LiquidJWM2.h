...
class LiquidJWM2 : public Print {
public:
	LiquidJWM2(uint8_t i2cAddr);
	...
	void crunchBits(uint8_t, uint8_t, uint8_t);
	void pulseEnable();
...
#endif
//	virtual size_t writeWait(uint8_t);

	void command(uint8_t);
//	void commandWait(uint8_t);
